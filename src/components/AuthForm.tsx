  ...
  return (
    ...
    >
      <Card className="w-full max-w-md mx-auto shadow-lg border-border/50">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">Welcome to Health Guardian</CardTitle>
          <CardDescription className="text-center">
            Sign in or create an account to track your health journey
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex flex-col space-y-4 pt-2">
          ...
          <AnimatedButton
            ...
            className="flex items-center justify-center w-full hover:bg-gray-100 transition-colors"
            disabled={isLoading}
          >
